...
class Camera
{
  Camera()
  {
    ...
    //position      = new PVector(250, 495, -268); // initial position
    position      = new PVector(705, 667, 312); // initial position
    theta         = PI/2; // rotation around Y axis. Starts with forward direction as ( 0, 0, -1 )
